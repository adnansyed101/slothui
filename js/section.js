...
const testimonials = [
  {
    ...
    avatar: "avatar-1.png",
    name: "X_AE_A-13",
    position: "Product Designer, slothUI",
  },
  {
    stars: "5.png",
    comment:
    ...
    avatar: "avatar-4.png",
    name: "Oarack Babama",
    position: "Former President of US",
  },
  {
    stars: "2.5.png",
    comment:
    ...
    avatar: "avatar-7.png",
    name: "Boe Jiden",
    position: "Former President Of Canada",
  },
  {
    stars: "4.5.png",
    comment:
  ...
  testimonials.forEach((testimonial) => {
    testimonialsContainer.innerHTML += `
     <div class="testimonial">
        <img src="./assets/testimonials/stars/${testimonial.stars}" alt="Stars" />
        <p>
          ${testimonial.comment}
        </p>
        <div class="person">
          <img
            src="./assets/testimonials/avatar/${testimonial.avatar}"
